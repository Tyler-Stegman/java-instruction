...
public class ContactManagerApp {
	...
	public static void main(String[] args) {
		...
		// print out a list of all contacts
		System.out.println("All contacts:");
		displayContacts(contacts);
		System.out.println();
		System.out.println("Contacts no phone (p. 709)");
		...
		System.out.println();
		System.out.println("Contacts with last name of Murach");
		List<Contact> contactsMurach = filterContacts(contacts, c -> c.getName().contains("Murach"));
		displayContacts(contactsMurach);
		System.out.println();
		System.out.println("Process contact list - print out the names (p. 711)");
...
//		displayContacts(contacts);
		System.out.println();
		System.out.println("Transform contact list to list of Strings (name:phone) (p. 713)");
