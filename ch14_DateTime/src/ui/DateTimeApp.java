...
public class DateTimeApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Memorial Day of next year..."+memorialDay.withYear(2021).withDayOfMonth(31));
		...
		System.out.println("current dat in long format: "+formatter.format(now1));
