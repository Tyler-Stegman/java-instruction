...
public class ContactManagerApp {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("Contacts no phone - print names (p. 717)");
		contacts.stream().filter(c -> c.getPhone() == null).forEach(c -> System.out.println(c.getName()));
		System.out.println();
		System.out.println("Contacts no phone - collect in new list: (p. 717)");
		...
		System.out.println();
		System.out.println("Transform contact list to list of names (p. 718):");
		...
		System.out.println();
		System.out.println("Transform contact list to list of names - double colon (p. 718):");
		contactNames = contacts.stream().map(Contact::getName).collect(Collectors.toList());
		contactNames.stream().forEach(System.out::println);
		System.out.println();
		System.out.println("Reduce a list of contacts to a single string (p. 721)");
