...
public class ContactManagerApp {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("List of contacts missing email - lamda:");
	...
	public static List<Contact> filterContactsWithoutPhone(List<Contact> contacts) {
		List<Contact> contactWithoutPhone = new ArrayList<>();
		for (Contact c : contacts) {
			if (c.getPhone() == null) {
				contactWithoutPhone.add(c);
			}
		}
		return contactWithoutPhone;
	}
